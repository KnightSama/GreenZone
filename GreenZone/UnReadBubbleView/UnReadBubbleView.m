...
-(void)dragMe:(UIPanGestureRecognizer *)ges{
    ...
    if (ges.state == UIGestureRecognizerStateBegan) {
        ...
        if (self.delegate&&[self.delegate respondsToSelector:@selector(UnReadBubbleViewPanGestureStartWithBackView:withfrontView:)]) {
            [self.delegate UnReadBubbleViewPanGestureStartWithBackView:backView withfrontView:frontView];
        }
...
//            displayLink = nil;
        ...
        if (self.delegate&&[self.delegate respondsToSelector:@selector(UnReadBubbleViewPanGestureChangeWithBackView:withfrontView:)]) {
            [self.delegate UnReadBubbleViewPanGestureChangeWithBackView:backView withfrontView:frontView];
        }
        ...
        if (self.delegate&&[self.delegate respondsToSelector:@selector(UnReadBubbleViewPanGestureEndWithBackView:withfrontView:)]) {
            [self.delegate UnReadBubbleViewPanGestureEndWithBackView:backView withfrontView:frontView];
        }
//        CGFloat xDist = (frontView.frame.origin.x - initialPoint.x);
//        
//        CGFloat yDist = (frontView.frame.origin.y - initialPoint.y);
